...
public class DbUtil {
        ...
        public static void addNewCustomer(Map<String, Object> params) throws SQLException {
                ...
                //System.out.println("Customer id before adding: " + CustomerCrudService.getCustomerId());
        ...
        public static Blob getLocation() throws SQLException {
                Connection conn = DriverManager.getConnection(URL, USR, PWD);
